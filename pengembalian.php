  ...
  <div class="content">
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
      ...
      $query = $mysqli->query($sql);
            ...
            if ($query && mysqli_num_rows($query) > 0) { // Periksa apakah ada hasil dari query
              $no = 1;
              while ($lihat = mysqli_fetch_array($query)) {
                ...
                <tr>
                  ...
                  <td> <a href="editpengembalian.php?id_pengembalian=<?php echo $lihat['id']; ?>" class="btn btn-primary"><i class="fas fa-edit"> Edit</i></a>
                    <a href="hapuspengembalian.php?id=<?php echo $lihat['id']; ?>" class="btn btn-danger"><i class="fa fa-trash"> Hapus</i></a>
                  </td>
                </tr>
              ...
              echo "<p>Tidak ada data pengembalian yang tersedia.</p>";
            }
            ?>
          </div>
        </div>
