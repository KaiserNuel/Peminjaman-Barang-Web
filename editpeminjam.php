                ...
                <div class = "box-body">
                  ...
                  <div class="form-group mt-3">
                    ...
                    <select name="jurusan" class="form-control mt-2">
                      ...
                      <option value="Informatika" <?php if ($qu['jurusan'] == 'Informatika') echo 'selected'; ?>>Informatika</option>
                      <option value="Sistem Informasi" <?php if ($qu['jurusan'] == 'Sistem Informasi') echo 'selected'; ?>>Sistem Informasi</option>
                      <option value="Teknologi Informasi" <?php if ($qu['jurusan'] == 'Teknologi Informasi') echo 'selected'; ?>>Teknologi Informasi</option>
                      <option value="Teknik Komputer" <?php if ($qu['jurusan'] == 'Teknik Komputer') echo 'selected'; ?>>Teknik Komputer</option>
                    </select>
                  </div>

                  <div class="form-group mt-3">
                    <label for="exampleInputPassword1">Nomor Kelas :</label>
                    <select name="no_kelas" class="form-control mt-2">
                      <option value="" disabled>- No Kelas -</option>
                      <?php
                      for ($i = 1; $i <= 6; $i++) {
                        $selected = ($qu['no_kelas'] == $i) ? 'selected' : '';
