        ...
        <div class="row  ">
            <div class="col-6  d-flex align-items-center">
                <div class="bungkus ms-5" style="width: 35vw; margin-top: 100px;">
                    ...
                    <p class="mt-4" style="margin-left: 50px">Selamat Datang di Aplikasi Pemimjaman Barang Lab, Tempat Terbaik untuk Memenuhi Kebutuhan Peminjaman Barang Laboratorium Komputer !!</p>
